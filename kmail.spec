...
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/kmail-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/kmail-22.08.2.tar.xz.sig
...
%prep
%setup -q -n kmail-22.08.2
cd %{_builddir}/kmail-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665780384
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkmailprivate.so.5.21.2
