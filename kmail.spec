...
Version  : 21.12.0
Release  : 37
URL      : https://download.kde.org/stable/release-service/21.12.0/src/kmail-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kmail-21.12.0.tar.xz
...
%prep
%setup -q -n kmail-21.12.0
cd %{_builddir}/kmail-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639700655
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmail-21.12.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kmail/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kmail-21.12.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kmail/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kmail-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kmail/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kmail-21.12.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kmail/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kmail-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmail/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kmail-21.12.0/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kmail/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kmail-21.12.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kmail/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmail-21.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmail/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmail-21.12.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kmail/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kmail-21.12.0/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kmail/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
...
/usr/lib64/libkmailprivate.so.5.19.0
