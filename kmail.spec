...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/kmail-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/kmail-22.12.1.tar.xz.sig
...
%prep
%setup -q -n kmail-22.12.1
cd %{_builddir}/kmail-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673389292
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkmailprivate.so.5.22.1
