...
Version  : 25.04.0
Release  : 121
URL      : https://download.kde.org/stable/release-service/25.04.0/src/kmail-25.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kmail-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kmail-25.04.0.tar.xz.sig
...
%setup -q -n kmail-25.04.0
cd %{_builddir}/kmail-25.04.0
pushd ..
cp -a kmail-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745000823
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkmailprivate.so.6.4.0
/V3/usr/lib64/libmailfilteragentprivate.so.6.4.0
...
/V3/usr/lib64/qt6/plugins/pim6/akonadi/config/sendlateragentconfig.so
...
/usr/lib64/libkmailprivate.so.6.4.0
/usr/lib64/libmailfilteragentprivate.so.6
/usr/lib64/libmailfilteragentprivate.so.6.4.0
...
/usr/lib64/qt6/plugins/pim6/akonadi/config/sendlateragentconfig.so
