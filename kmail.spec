...
Version  : 25.04.1
Release  : 124
URL      : https://download.kde.org/stable/release-service/25.04.1/src/kmail-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kmail-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kmail-25.04.1.tar.xz.sig
...
%setup -q -n kmail-25.04.1
cd %{_builddir}/kmail-25.04.1
pushd ..
cp -a kmail-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747192680
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkmailprivate.so.6.4.1
/V3/usr/lib64/libmailfilteragentprivate.so.6.4.1
...
/usr/lib64/libkmailprivate.so.6.4.1
/usr/lib64/libmailfilteragentprivate.so.6
/usr/lib64/libmailfilteragentprivate.so.6.4.1
