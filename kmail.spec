...
%setup -q -n kmail-24.05.1
cd %{_builddir}/kmail-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718640346
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkmailprivate.so.6.1.1
/V3/usr/lib64/libmailfilteragentprivate.so.6.1.1
...
/usr/lib64/libkmailprivate.so.6.1.1
/usr/lib64/libmailfilteragentprivate.so.6
/usr/lib64/libmailfilteragentprivate.so.6.1.1
