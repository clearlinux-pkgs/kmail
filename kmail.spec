...
Version  : 24.12.2
Release  : 118
URL      : https://download.kde.org/stable/release-service/24.12.2/src/kmail-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kmail-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kmail-24.12.2.tar.xz.sig
...
%setup -q -n kmail-24.12.2
cd %{_builddir}/kmail-24.12.2
pushd ..
cp -a kmail-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739218482
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkmailprivate.so.6.3.2
/V3/usr/lib64/libmailfilteragentprivate.so.6.3.2
...
/usr/lib64/libkmailprivate.so.6.3.2
/usr/lib64/libmailfilteragentprivate.so.6
/usr/lib64/libmailfilteragentprivate.so.6.3.2
