...
%setup -q -n kmail-24.12.3
cd %{_builddir}/kmail-24.12.3
pushd ..
cp -a kmail-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742524680
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkmailprivate.so.6.3.3
/V3/usr/lib64/libmailfilteragentprivate.so.6.3.3
...
/usr/lib64/libkmailprivate.so.6.3.3
/usr/lib64/libmailfilteragentprivate.so.6
/usr/lib64/libmailfilteragentprivate.so.6.3.3
