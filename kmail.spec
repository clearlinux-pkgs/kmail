...
Version  : 23.08.4
Release  : 83
URL      : https://download.kde.org/stable/release-service/23.08.4/src/kmail-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/kmail-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/kmail-23.08.4.tar.xz.sig
...
%prep
%setup -q -n kmail-23.08.4
cd %{_builddir}/kmail-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703020590
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkmailprivate.so.5.24.4
...
/usr/lib64/libkmailprivate.so.5.24.4
