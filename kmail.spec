...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kmail-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kmail-24.08.0.tar.xz.sig
...
%setup -q -n kmail-24.08.0
cd %{_builddir}/kmail-24.08.0
pushd ..
cp -a kmail-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724699048
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkmailprivate.so.6.2.0
/V3/usr/lib64/libmailfilteragentprivate.so.6.2.0
...
/usr/lib64/libkmailprivate.so.6.2.0
/usr/lib64/libmailfilteragentprivate.so.6
/usr/lib64/libmailfilteragentprivate.so.6.2.0
