...
Version  : 19.12.1
Release  : 17
URL      : https://download.kde.org/stable/release-service/19.12.1/src/kmail-19.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/kmail-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/kmail-19.12.1.tar.xz.sig
...
%prep
%setup -q -n kmail-19.12.1
cd %{_builddir}/kmail-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578955705
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmail-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/kmail/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kmail-19.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmail/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kmail-19.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kmail/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/kmail-19.12.1/ktnef/COPYING %{buildroot}/usr/share/package-licenses/kmail/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kmail-19.12.1/ktnef/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmail/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kmail-19.12.1/ktnef/COPYING.LIB %{buildroot}/usr/share/package-licenses/kmail/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libkmailprivate.so.5.13.1
