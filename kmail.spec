...
Source0  : https://download.kde.org/stable/release-service/21.08.2/src/kmail-21.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.2/src/kmail-21.08.2.tar.xz.sig
...
%prep
%setup -q -n kmail-21.08.2
cd %{_builddir}/kmail-21.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634501553
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmail-21.08.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kmail/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kmail-21.08.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kmail/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kmail-21.08.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kmail/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kmail-21.08.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kmail/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kmail-21.08.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmail/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kmail-21.08.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kmail/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/kmail-21.08.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kmail/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmail-21.08.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmail/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kmail-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kmail/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/kmail-21.08.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kmail/7d9831e05094ce723947d729c2a46a09d6e90275
pushd clr-build
%make_install
popd
...
/usr/lib64/libkmailprivate.so.5.18.2
